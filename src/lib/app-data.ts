...
export const studentNavItems: NavItem[] = [
  ...
  { title: "MCQ Practice", to: "/mcq-practice", icon: ListChecks, keywords: ["practice", "mcq"] },
  {
    ...
    to: "/routine",
    icon: CalendarClock,
    keywords: ["routine", "schedule", "plan", "study plan"],
  },
  {
    title: "Subject Progress",
    to: "/subject-progress",
    icon: BookOpenCheck,
    keywords: ["subject", "progress", "chapter", "completion", "syllabus"],
  },
...
export const adminNavItems: NavItem[] = [
  ...
  },
  {
    ...
    to: "/admin/routine",
    icon: CalendarClock,
    keywords: ["routine", "schedule", "study plan", "planner"],
  },
  {
    title: "Subject Progress Manager",
    to: "/admin/subject-progress",
    icon: BookOpenCheck,
    keywords: ["subject", "progress", "chapter", "syllabus", "completion", "tracking"],
  },
